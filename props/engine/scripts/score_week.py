...
def main():
    ...
    if not C.empty:
        ...
        L += ["", "*A thin board (under ~24 posted lines) means a narrower set of starters was priced, not a cleaner read"
              ...
              "model beats a book on the calls it would actually make. The 2022-25 yardage harness finds receptions, receiving yards and rushing yards unbiased but too narrow (a model 85% wins about 77-80%). "
